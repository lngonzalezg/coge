...
unless ( process_gff_file() ) {
    print STDOUT "log: error: no annotations found, perhaps your file is missing required information, <span class='bold alert'>please check the <a href='https://genomevolution.org/wiki/index.php?title=GFF_ingestion'>GFF documentation</a></span>\n";
    exit(-1);
}
